  ...
  return (
    <Section className='Header' background='light'>
      ...
      <div className='buttons' align='center'>
        <a className='ActionButton white' href={'http://https://bobotinho-load-balancer.herokuapp.com/invite'} target='_self'>Adicionar</a>
      </div>
    </Section>
  );
}
  ...
  return (
    <Section className='GetStarted' background='tint'>
      ...
      <h2 className='Heading'>Está esperando o quê?</h2>
        ...
        <div className='buttons' align='center'>
          <a className='ActionButton brand' href={'http://https://bobotinho-load-balancer.herokuapp.com/invite'} target='_self'>Adicionar</a>
        </div>
      </div>
    </Section>
  );
